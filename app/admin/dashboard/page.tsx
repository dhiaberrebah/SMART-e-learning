    ...
    <div className="min-h-screen bg-gray-50">
      <nav className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <h1 className="text-xl font-bold text-indigo-600">لوحة تحكم المسؤول</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-1">هذه لوحة تحكم المسؤول - قريباً سيتم إضافة المزيد من الميزات</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">إدارة المستخدمين</h3>
            <p className="text-gray-600 text-sm mb-4">إضافة وتعديل المستخدمين</p>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="text-gray-600 text-sm mb-4">إحصائيات عامة للمنصة</p>
            <Link href="#" className="text-indigo-600 hover:text-indigo-700 text-sm font-medium">
              عرض الإحصائيات →
            </Link>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="text-gray-600 text-sm mb-4">إعدادات النظام العامة</p>
            <Link href="#" className="text-indigo-600 hover:text-indigo-700 text-sm font-medium">
              الإعدادات →
            </Link>
          </div>
